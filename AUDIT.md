...
| `/about` | `src/app/about/page.tsx` | About Lucinda Reader / Ravello HR | **Rewrite → Lucy + Tom / The People System** (Phase 1C) |
...
| `/why-ravello` | `src/app/why-ravello/page.tsx` | Comparison page: why not agency/in-house | **Repurpose → Why The People System** (Phase 1D) |
...
**Change needed:** Update signals to The People System positioning (two founders, combined capability).
...
**Change needed:** Update pain points to align with HIRE / LEAD / PROTECT framing and The People System language.
...
**Change needed:** Update copy for The People System positioning. Update secondary CTA.
...
**Change needed:** Update Solutions dropdown to HIRE / LEAD / PROTECT / Friction Lens. Rename "Why Ravello" → "Why The People System". Phase 1D.
