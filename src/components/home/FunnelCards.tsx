...
const funnels = [
  ...
  },
  {
    ...
    body: 'A People Director costs £90k+ before NI and benefits. You get senior thinking, day-to-day manager backing, and a learning culture that holds onto the people you can’t afford to lose. Embedded. Fraction of the cost.',
    pains: [
      'No consistent HR leadership. Your best people see it and leave.',
      'People strategy stuck in a drawer, or never written down.',
      'Managers without the tools for hard conversations. Issues fester.',
    ],
  ...
  },
  {
    ...
    body: 'The mean tribunal award for unfair dismissal: £13,749, before legal fees (MoJ, 2023/24). Missing contracts, outdated handbooks, and the gaps the new Employment Rights Bill will expose. We build the foundations that protect your business. Documented, watertight, and built around how you actually work.',
    pains: [
      ...
      "Compliance exposure you can't currently see, until it becomes a claim.",
    ],
