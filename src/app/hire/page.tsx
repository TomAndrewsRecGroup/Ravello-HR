    ...
    <div className="pt-20">
      ...
      <section className="section-sm" style={{ background: 'var(--surface-alt)' }}>
        <div className="container-narrow text-center">
          <h2 className="section-title mb-4">Not sure which package fits?</h2>
      ...
      <FaqBlock items={[
        ...
        { q: 'What is Friction Lens and is it included?', a: 'Friction Lens is Tom\'s proprietary role scoring system. It assesses every active role across five dimensions — Location, Salary, Skills, Working Model, and Process — against live market data and produces a friction score (Low to Critical) with specific recommendations. It is included as standard in every HIRE package.' },
