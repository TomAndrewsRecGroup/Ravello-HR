      ...
      <section className="section-padding" style={{ background: 'var(--surface)' }}>
        <div className="container-wide">
          <div className="max-w-[600px] mb-12">
            <h2 className="font-display section-title mb-4">The 5 reasons<br /><span className="text-gradient">your hiring keeps failing</span></h2>
      ...
      <section className="section-padding" style={{ background: 'var(--bg)' }}>
        <div className="container-wide">
          <div className="text-center mb-12">
            <h2 className="font-display section-title mb-4">How<br /><span className="text-gradient">HIRE works</span></h2>
      ...
      <section className="section-padding" style={{ background: 'var(--brand-navy)' }}>
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display section-title-light mb-6">What changes<br /><span style={{ background: 'var(--gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>when HIRE is working</span></h2>
