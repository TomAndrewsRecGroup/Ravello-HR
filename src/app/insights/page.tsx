...
export default function InsightsPage() {
  return (
    <div className="pt-28">
      ...
      {/* FAQ */}
      <FaqBlock items={[
        { q: 'What is Friction Lens?', a: 'Friction Lens is a third-party role-scoring technology developed by IvyLens Technology. The People System is an integration partner: every HIRE engagement runs Friction Lens on each active role across five dimensions (Location, Salary, Skills, Working Model, and Process) before it goes to market. Scores live in your portal under HIRE. The methodology is owned and maintained by IvyLens.' },
