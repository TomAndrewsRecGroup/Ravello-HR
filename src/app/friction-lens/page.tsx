  ...
  return (
    <div className="pt-28">
        ...
        <div className="container-narrow">
          ...
          <div className="space-y-5">
            {[
              ...
              { step: '03', title: 'Score and recommendations delivered', body: 'You receive a written Friction Lens report: overall score, dimension-by-dimension breakdown, and specific recommendations for anything rated Medium or above. Returned quickly after briefing.' },
      ...
      <FaqBlock items={[
        ...
        { q: 'How long does a Friction Lens score take?', a: 'Quick turnaround once you send the role brief. Complex or specialist roles take a little longer.' },
