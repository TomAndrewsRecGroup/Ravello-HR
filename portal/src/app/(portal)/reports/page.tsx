...
export default async function ReportsPage() {
  ...
  const { data: profile }  = await supabase.from('profiles').select('company_id, companies(feature_flags)').eq('id', user?.id ?? '').single();
          ...
          <div className="card p-12">
            <div className="empty-state">
              ...
              <p className="text-sm max-w-[320px]" style={{ color: 'var(--ink-faint)' }}>
                Reports generated by The People Office will appear here. They can be downloaded as PDFs.
              </p>
            </div>
          </div>
        ) : (
