...
export default function FrictionLensPage() {
  ...
  if (loading) {
    return (
      <>
        <Topbar title="Friction Lens" subtitle="Company HR Operations Assessment" />
  ...
  if (showForm) {
    ...
    return (
      <>
        <Topbar title="Company Assessment" subtitle={`Step ${step + 1} of ${totalSteps}`} />
  ...
  if (assessment) {
    ...
    return (
      <>
        <Topbar title="Friction Lens" subtitle="Your company's HR operations score" />
  ...
  return (
    <>
      <Topbar title="Friction Lens" subtitle="Understand what's slowing your HR operations" />
      <main className="portal-page flex-1 flex items-center justify-center">
