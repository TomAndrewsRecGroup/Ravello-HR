...
export default async function OffboardingPage() {
  ...
  const [templatesRes, instancesRes, employeesRes] = await Promise.all([
    ...
    supabase
      ...
      .select('id,company_id,employee_id,template_id,status,reason,exit_interview_notes,last_working_day,started_at,completed_at,employee_records(full_name, job_title),offboarding_task_progress(id,task_title,task_description,category,due_date,status,completed_at,sort_order)')
      .eq('company_id', companyId)
