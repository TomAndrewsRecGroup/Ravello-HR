      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold" style={{ color: 'var(--ink)' }}>
                Let Core OS 360 recruit for you
              </p>
          ...
          <Link prefetch={false} href="/hire/hiring/new" className="btn-cta btn-sm flex-shrink-0">
            <Briefcase size={13} /> Raise a Role with Core OS 360
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: 'var(--ink-faint)' }}>
                Transfer to Core OS 360 for experienced recruiter support, 60+ job board exposure and proactive candidate sourcing.
              </p>
            </div>
          </div>
        </div>
      ...
      {internalRoles.length === 0 ? (
        <div className="empty-state">
          ...
          <p className="text-xs" style={{ color: 'var(--ink-faint)' }}>
            For the best results, we recommend raising roles with Core OS 360.
          </p>
          <div className="flex items-center gap-2 mt-3">
            <Link prefetch={false} href="/hire/hiring/new" className="btn-cta btn-sm">
              <Sparkles size={13} /> Raise with Core OS 360
            </Link>
                    ...
                    {!isFilled && (
                      <div className="mt-4 pt-3 flex flex-col sm:flex-row sm:items-center gap-3" style={{ borderTop: '1px solid var(--line)' }}>
                        <div className="flex items-start gap-2 flex-1 min-w-0">
                          ...
                          <p className="text-xs" style={{ color: 'var(--ink-faint)' }}>
                            Transfer this role to Core OS 360 for 60+ job board exposure, proactive sourcing and dedicated recruiter support.
                          </p>
                        </div>
                        <button
            ...
            <div className="rounded-lg p-3 mb-4" style={{ background: 'rgba(11,120,150,0.04)', border: '1px solid rgba(11,120,150,0.12)' }}>
              <p className="text-xs leading-relaxed" style={{ color: 'var(--ink-soft)' }}>
                ...
                <Link prefetch={false} href="/hire/hiring/new" className="font-bold underline" style={{ color: 'var(--purple)' }}>
                  Raise with Core OS 360 instead →
                </Link>
              </p>
            </div>
