...
interface Props {
  /** Server-fetched assessment (or null if none yet). */
  initialAssessment: CompanyAssessment | null;
  /** Server-fetched company info — saves an auth + profile + companies round-trip on submit. */
  company: {
    id: string;
    name: string | null;
    sector: string | null;
