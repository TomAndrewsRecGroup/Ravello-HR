...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/requests',        label: 'Support & Requests', icon: LifeBuoy },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="text-[9px] font-semibold uppercase tracking-[0.08em] ml-auto px-2 py-0.5 rounded-md" style={{ background: 'rgba(11,120,150,0.08)', color: 'var(--purple)' }}>
            Admin
          </span>
