...
const nav = [
  ...
  { href: '/engagement',      label: 'Engagement',       icon: Activity,        sub: null },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span
            className="text-[9px] font-bold uppercase tracking-[0.16em] ml-auto px-2 py-0.5 rounded-[6px] hide-mobile-close"
            style={{
