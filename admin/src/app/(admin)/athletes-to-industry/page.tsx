...
export default async function AthletesToIndustryAdminPage() {
  ...
  const [
    ...
    supabase
      .from('athletes')
      .select('id, company_id, full_name, email, phone, sport, previous_role, bio, linkedin_url, avatar_url, cv_kind, cv_url, cv_filename, cv_mime, cv_text, called_at, created_at, companies(name)')
