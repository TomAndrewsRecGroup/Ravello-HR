    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--navy)' }}>
      <div className="relative w-full max-w-[380px]">
        <div className="flex justify-center mb-8">
          <Image src={LOGO} alt="Ravello" width={130} height={44} className="h-10 w-auto brightness-110" priority />
        </div>
        <div className="rounded-[20px] p-8" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <p className="text-sm mb-7" style={{ color: 'rgba(255,255,255,0.4)' }}>Ravello staff access only</p>
          <AdminLoginForm />
        </div>
      </div>
    </div>
