...
export const STATUS_META: Record<ReferralStatus, StatusMeta> = {
  ...
  applied_to_partner:  { label: 'Applied to partner',   group: 'downstream', colour: 'var(--blue)', manual: true },
  ai_interview:        { label: 'AI interview',         group: 'downstream', colour: 'var(--indigo)', manual: true },
