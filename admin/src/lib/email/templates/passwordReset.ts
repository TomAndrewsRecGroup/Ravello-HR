...
<p style="margin:0 0 16px 0;">A password reset has been requested for your Core OS 360 account. Click the button below to set a new password. The link is valid for <strong>1 hour</strong>.</p>
...
`.trim();
  ...
  return {
    to:      input.to,
    subject: 'Reset your Core OS 360 password',
    html:    wrapEmail(body, `Reset your Core OS 360 password.`),
    tag:     'password-reset',
  };
}
