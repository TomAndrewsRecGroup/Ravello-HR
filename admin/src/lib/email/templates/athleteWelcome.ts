import { wrapEmailA2I, ctaButtonA2I, A2I } from '../layout';
...
// Athletes To Industry's own gold/navy identity (wrapEmailA2I), not the
// purple TPS shell. This email is signed by Tom Andrews and describes
// Andrews Recruitment Group's programme — see the note on A2I in
// ../layout.ts for why it moved off the generic shell.
...
`.trim();
  ...
  return {
    ...
    html:    wrapEmailA2I(body, "Welcome to Athletes To Industry - book a call with Tom to get started."),
    tag:     'athlete-welcome',
  };
}
